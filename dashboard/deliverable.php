                            ...
                            <div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="img-responsive">
                                            <hr>
                                            <h5>Variants:</h5>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <img src="image-path.jpg" class="img-responsive">
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <td><button class="btn btn-default btn-sm col-md-2">Update Name</button></td>
                                                    <td><button class="btn btn-danger btn-sm col-md-2">Delete</button></td>
                                                    <td><button class="btn btn-success btn-sm col-md-2">Download</button></td>
                                                    <td><button class="btn btn-primary btn-sm col-md-2">Replace</button></td>
                                                </div>
