                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="list-group">
                                        <a href="#" class="list-group-item">Deliverable 1
                                        ...
                                        <a href="#" class="list-group-item">Deliverable 2
                                            <span class="pull-right">
                                                <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#assignModal"><i class="glyphicon glyphicon-plus"></i> Assign</button>
                                            </span>
                                        </a>
                                        <a href="#" class="list-group-item">Deliverable 3
                                            <span class="pull-right">
                                                <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#assignModal"><i class="glyphicon glyphicon-plus"></i> Assign</button>
                                            </span>
                                        </a>
                                        <a href="#" class="list-group-item">Deliverable 4
                                            <span class="pull-right">
                                                <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#assignModal"><i class="glyphicon glyphicon-plus"></i> Assign</button>
                                            </span>
                                        </a>
                                        <a href="#" class="list-group-item">Deliverable 5
                                            <span class="pull-right">
                                                <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#assignModal"><i class="glyphicon glyphicon-plus"></i> Assign</button>
                                            </span>
                                        </a>
