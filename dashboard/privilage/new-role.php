                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="create_reason" name="permissions[create_reason]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="update_reason" name="permissions[update_reason]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="create_user" name="permissions[create_user]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="update_user" name="permissions[update_user]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="create_project" name="permissions[create_project]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="update_project" name="permissions[update_project]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="view_file" name="permissions[view_file]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="create_file" name="permissions[create_file]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="update_file" name="permissions[update_file]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="view_task_log" name="permissions[view_task_log]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="view_roles_permission" name="permissions[view_roles_permission]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="create_roles_permission" name="permissions[create_roles_permission]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="update_roles_permission" name="permissions[update_roles_permission]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="view_ticket" name="permissions[view_ticket]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="create_ticket" name="permissions[create_ticket]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="update_ticket" name="permissions[update_ticket]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="view_ticket_mangment" name="permissions[view_ticket_mangment]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="create_ticket_mangment" name="permissions[create_ticket_mangment]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="update_ticket_mangment" name="permissions[update_ticket_mangment]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="view_setting" name="permissions[view_setting]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="create_setting" name="permissions[create_setting]" value="FALSE" type="checkbox" checked />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="material-switch">
                                      <input id="update_setting" name="permissions[update_setting]" value="FALSE" type="checkbox" checked />
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#create_task_type, #update_task_type').change(function() {
          var checked = $(this).prop('checked');
          $('#view_task_type').prop('checked', checked);
        });
        ...
        $('#create_project, #update_project').change(function() {
          var checked = $(this).prop('checked');
          $('#view_project').prop('checked', checked);
        });

        // Disable View permission when Create or Update permission is enabled for other permissions
        // Repeat the above code for each permission
      });
