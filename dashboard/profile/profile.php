...
<head>
    ...
    <title>Profile | Image Drive</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-6">
                                        <div class="address-hr biography">
                                            <p><b>Full Name</b><br /> Adrash Halder</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-6">
                                        <div class="address-hr biography">
                                            <p><b>Designatation</b><br /> Manager</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-6">
                                        <div class="address-hr biography">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="file-upload-inner ts-forms">
                                                            <div class="input prepend-big-btn">
                                                                ...
                                                                <input type="text" id="prepend-big-btn" placeholder="Update Profile Picture">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
