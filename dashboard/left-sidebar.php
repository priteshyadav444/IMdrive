            ...
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="master List" href="master.php"><span class="mini-sub-pro">User
                                        Master Lists</span></a></li>
                            <li><a title="Add Master List" href="add-masterlist.php"><span class="mini-sub-pro">Add
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="User List" href="user.php"><span class="mini-sub-pro">User
                                        List</span></a></li>
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            ...
                            <li><a title="Add User" href=""><span class="mini-sub-pro">Add Email</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a class="has-arrow" href="all-courses.php" aria-expanded="false">
                            ...
                            <span class="mini-click-non">Roles</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Add User" href="rolelist.php"><span class="mini-sub-pro">View All</span></a></li>
                        </ul>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Add User" href="new-role.php"><span class="mini-sub-pro">Add New Role</span></a></li>
                        </ul>
